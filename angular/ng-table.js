(function(angular, factory) {
    ...
    (function(){
         ...
         *********
         *****
         * @description 修改全选: 点击全选修改为只选中当前页面显示条数，不包括全部，修改显示条数亦可，互不影响
         * @modification 修改行数起始位置(共两处): 737~741， 771~775
         */

        angular.module('ngTable').factory('NgTableParams', ['$q', '$rootScope', '$log', '$filter', 'ngTableDefaults', 'ngTableGetDataBcShim', 'ngTableDefaultGetData', 'ngTableEventsChannel',
            function($q, $rootScope, $log, $filter, ngTableDefaults, ngTableGetDataBcShim, ngTableDefaultGetData, ngTableEventsChannel) {
                ...
                var NgTableParams = function(baseParameters, baseSettings) {
                    ...
                    this.page = function(page) {
                        /**
                         * @description current: 记录选中当前页
                         */
                        $rootScope.current = params.page;
                        /* The End */
                    ...
                    this.count = function(count) {
                        /**
                         * @description current_count: 记录当前显示条数
                         */
                        $rootScope.current_count = params.count;
                        /* The End */
